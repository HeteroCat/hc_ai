...
interface SplashCursorProps {
  ...
  CURL?: number;
  SPLAT_RADIUS?: number; // 斑点半径，数值越小越集中
  SPLAT_FORCE?: number; // 增大 splat 力度
  SHADING?: boolean;
  COLOR_UPDATE_SPEED?: number; // 加快颜色更新速度
  BACK_COLOR?: ColorRGB; // 背景颜色亮度
  TRANSPARENT?: boolean;
}
...
export default function SplashCursor({
  ...
  return (
    <div className="fixed top-0 left-0 z-50 pointer-events-none w-full h-full" style={{ filter: 'contrast(1.5) brightness(1.2)' }}>
